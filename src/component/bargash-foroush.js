...
import Bargashtforoushcamera from "./camera-bargasht-foroush";


class Bargashtforoush extends Component {
   ...
   render(){
    ...
    return(
        ...
        <div className="sa-center sa-items-wrapper-home">
            <Bargashtforoushcamera   agent_id={this.props.location.state.agent_id}/>
            <div className="sa-red-line"></div>
            <Link to={{pathname:"/write-barcode",state:{scanpart:"bargasht-foroush",agent_id:this.props.location.state.agent_id}}}>
...
export default Bargashtforoush;